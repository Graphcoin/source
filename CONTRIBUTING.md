Contributing to Graphcoin Core
============================

The Graphcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Graphcoin Core project, and is not to be
confused with overall Graphcoin Network Protocol consensus changes.

Whether a pull request is merged into Graphcoin Core rests with the project merge
...
Patches that change Graphcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Graphcoin consensus, it must have been
...
The project leader is the release manager for each Graphcoin Core release.
