...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Graphcoin Core graphcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  graphcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded graphcoin transaction") + "\n" +
                               "  graphcoin-tx [options] -create [commands]   " + _("Create hex-encoded graphcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded graphcoin transaction
