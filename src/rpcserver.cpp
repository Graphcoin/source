...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Graphcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Graphcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Graphcoin features */
        {"graphcoin", "masternode", &masternode, true, true, false},
        {"graphcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"graphcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"graphcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"graphcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"graphcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"graphcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"graphcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"graphcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"graphcoin", "startmasternode", &startmasternode, true, true, false},
        {"graphcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"graphcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"graphcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"graphcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"graphcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"graphcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        /*
        {"graphcoin", "mnbudget", &mnbudget, true, true, false},
        {"graphcoin", "preparebudget", &preparebudget, true, true, false},
        {"graphcoin", "submitbudget", &submitbudget, true, true, false},
        {"graphcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"graphcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"graphcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"graphcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"graphcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"graphcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"graphcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"graphcoin", "checkbudgets", &checkbudgets, true, true, false},
        */
        {"graphcoin", "mnsync", &mnsync, true, true, false},
        {"graphcoin", "spork", &spork, true, true, false},
        {"graphcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgrphseed", &getzgrphseed, false, false, true},
        {"zerocoin", "setzgrphseed", &setzgrphseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgrph", &searchdzgrph, false, false, true},
        {"zerocoin", "dzgrphstate", &dzgrphstate, false, false, true}
...
{
    return "> graphcoin-cli " + methodname + " " + args + "\n";
}
