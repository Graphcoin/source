 ...
 * Graphcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int BLOCK_REQUIRE_MN_SYNC() const { return nBlockRequireMNSync; }
