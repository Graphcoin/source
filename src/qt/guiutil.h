...
/** Utility functions used by the Graphcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Graphcoin addresses in monospace font
...
// Parse "graphcoin:" URI into recipient object, return true on successful parsing
