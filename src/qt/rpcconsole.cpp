                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGRPHPathCustom = GetArg("-zgrphbackuppath", "");
    ...
    if(!strzGRPHPathCustom.empty()) {
        ui->wallet_customzgrphbackuppath->setText(QString::fromStdString(strzGRPHPathCustom));
        ui->wallet_customzgrphbackuppath_label->setVisible(true);
        ui->wallet_customzgrphbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGRPHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        ...
        "td.cmd-request { color: #5eff00; } "
        "td.cmd-error { color: red; } "
        "b { color: #5eff00; } ");

    message(CMD_REPLY, (tr("Welcome to the Graphcoin RPC console.") + "<br>" +
