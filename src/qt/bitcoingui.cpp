                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Graphcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Graphcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and graphcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGRPH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Graphcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Graphcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Graphcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Graphcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Graphcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Graphcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Graphcoin Core help message to get a list with possible Graphcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Graphcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Graphcoin network", "", count));
}
...
{
    QString strTitle = tr("Graphcoin Core"); // default title
