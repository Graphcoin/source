...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Graphcoin Core"),
     ...
     * override -datadir in the graphcoin.conf file in the default data directory
     * (to be consistent with graphcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
