...
/**
 * Graphcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzgrphseed(const UniValue& params, bool fHelp);
extern UniValue getzgrphseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgrph(const UniValue& params, bool fHelp);
extern UniValue dzgrphstate(const UniValue& params, bool fHelp);
