...
In order to support loading of multiple wallets in graphcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is graphcoin.cpp.
...
Changes to graphcoin.cpp
----------------------
graphcoin.cpp is the entry point into graphcoin-qt, and as such, will require some minor modifications to provide hooks for
