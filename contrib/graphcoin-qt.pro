...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/graphcoin-cli.cpp \
           src/graphcoin-tx.cpp \
           src/graphcoin.cpp \
           src/db.cpp \
           ...
           src/qt/graphcoin.cpp \
           src/qt/graphcoinstrings.cpp \
...
RESOURCES += src/qt/graphcoin.qrc src/qt/graphcoin_locale.qrc

TRANSLATIONS += src/qt/locale/graphcoin_bg.ts \
                src/qt/locale/graphcoin_de.ts \
                src/qt/locale/graphcoin_en.ts \
                src/qt/locale/graphcoin_es.ts \
                src/qt/locale/graphcoin_fi.ts \
                src/qt/locale/graphcoin_fr.ts \
                src/qt/locale/graphcoin_it.ts \
                src/qt/locale/graphcoin_ja.ts \
                src/qt/locale/graphcoin_pl.ts \
                src/qt/locale/graphcoin_pt.ts \
                src/qt/locale/graphcoin_ru.ts \
                src/qt/locale/graphcoin_sk.ts \
                src/qt/locale/graphcoin_sv.ts \
                src/qt/locale/graphcoin_vi.ts \
                src/qt/locale/graphcoin_zh_CN.ts \
                src/qt/locale/graphcoin_zh_TW.ts
